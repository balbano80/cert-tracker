...
const About = () => (
  <div>
    <Hero backgroundImage="http://www.industrialtracker.com/wp-content/uploads/2016/07/hp-slide_01-2.jpg">
      <h1>Industrial Tracker</h1>
      <h2>Implement data tracking faster than ever</h2>
    </Hero>
    <Container style={{ marginTop: 30 }}>
      <Row>
        <Col size="md-12">
          <h1>Welcome To Industrial Tracker!</h1>
        </Col>
      </Row>
      <Row>
        <Col size="md-12">
